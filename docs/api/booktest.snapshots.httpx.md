...
# <kbd>module</kbd> `booktest.snapshots.httpx`
...
__init__(
    ...
    json_to_hash=None,
    encode_body=None,
    match_request=<function accept_all at 0x7e77b54ba480>
)
```
...
### <kbd>method</kbd> `async_snapshot_request`
...
### <kbd>method</kbd> `handle_async_request`
...
### <kbd>method</kbd> `snapshot_request`
